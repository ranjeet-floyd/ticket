...
function (_React$Component2) {
  ...
  _createClass(UserList, [{
    ...
    value: function render() {
      ...
      return React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", null, "First Name"), React.createElement("th", null, "Last Name"), React.createElement("th", null, "Description")), users));
    }
  }]);
...
function (_React$Component3) {
  ...
  _createClass(User, [{
    key: "render",
    value: function render() {
      return React.createElement("tr", null, React.createElement("td", null, this.props.user.firstName), React.createElement("td", null, this.props.user.lastName), React.createElement("td", null, this.props.user.description));
    }
  }]);
